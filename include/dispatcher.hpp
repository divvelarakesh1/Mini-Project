 ...
 * should physically be updated. Currently acts as a non-blocking pass-through
 * but can be scaled to implement complex lock-free concurrency bounds.
 */
class Dispatcher {
public:
  ...
  bool finish_step(int /*step_index*/) { return true; }
